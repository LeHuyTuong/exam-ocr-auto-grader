      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // Tạm ẩn ở bản release (APK production) — còn dữ liệu demo trùng
            // lặp và tính năng chưa hoàn thiện đủ để giao cho giáo viên dùng
            // thật; vẫn hiện ở debug để tiếp tục phát triển/test.
            if (!kReleaseMode)
              AppCard(
                onTap: () => Navigator.push(
                  context,
